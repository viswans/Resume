...
\Point{Survey of existing timing methods - Exploring features and methods of implementing Statistical Static Timing Analysis Model \textbf{SSTA}}
\Point{Implementing the SSTA algorithm and accelerating it in NVidia Graphics processors using \textbf{CUDA}}
...
\Point{\textbf{Led the Election Engineering Team} for the Student Body Elections 2011. Implemented a \textbf{Secure Web Based Voting} for a 5000-strong electorate across 20 polling stations}
