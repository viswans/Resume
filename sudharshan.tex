...
\Point{Coordinated the \textbf{Digital Electronics Workshop} for Shaastra 2011 (technical festival of IIT-Madras) with an average footfall of 1000 participants}
\Point{Won the \textbf{Puzzle Championship} event in Shaastra 2010}
\Point{Have given many violin concerts in the city along with a violin group known as \textbf{CARVA}}
\Point{Took Chemistry classes for 11th and 12th grade students for IIT-JEE in a reputed coaching institute known as \textbf{SMART} in Chennai}
\Point{Participated in hands-on workshop on \textbf{Project Management} under  \textbf{MITACS Step Program}, Canada}
